...
This standalone repository vendors the small `packages_custom/` helper module used by the app. The vendored copy is `packages_custom` version `0.1.0` from source commit `3e87d89`. Once published, the source repository URL will be <https://github.com/Cure-Interactive/packages-custom>.
